---
titulo: "Transformando Números Decimais em Binários"
tipo: rco-seed
...
ordem_rco: 1000
serie: 1
aula_rco: "Aula NIVELAMENTO 01"
slides: 20
tem_atividade: true
tem_pratica: true
fontes:
  - "lake/AULAS_RCO-20260922T223029Z-1-002/AULAS_RCO/IAC/2TRI/1000-transformando-numeros-decimais-em-binarios/1000-transformando-numeros-decimais-em-binarios.pptx"
  - "lake/AULAS_RCO-20260922T223029Z-1-002/AULAS_RCO/IAC/2TRI/1000-transformando-numeros-decimais-em-binarios/AULA NIVELAMENTO 01_INTRODUÇÃO A COMPUTAÇÃO ATIVIDADE.docx"
  - "lake/AULAS_RCO-20260922T223029Z-1-002/AULAS_RCO/IAC/2TRI/1000-transformando-numeros-decimais-em-binarios/AULA NIVELAMENTO 01_PRÁTICA INTRODUÇÃO A COMPUTAÇÃO.docx"
extrator: tools/extrair_rco.py
status: bruto
---

# Transformando Números Decimais em Binários
...
- Google Play
- App Store
- Fortalecer o nosso entendimento sobre cálculos de números binários.
...
- https://drive.google.com/file/d/121qTj7vli7B8wEWbVFc1qx8YEVhxl8Ne/view?usp=drive_link
...
_Fonte: AULA NIVELAMENTO 01_INTRODUÇÃO A COMPUTAÇÃO ATIVIDADE.docx_
...
_Fonte: AULA NIVELAMENTO 01_PRÁTICA INTRODUÇÃO A COMPUTAÇÃO.docx_
...
AULA PRÁTICA NIVELAMENTO 01

Resumo Explicativo:

O sistema binário é a base da computação digital. Enquanto usamos o sistema decimal no cotidiano (base 10), os computadores utilizam o sistema binário (base 2), formado apenas pelos dígitos 0 e 1. Aprender a converter números decimais para binários é essencial para compreender como as máquinas processam e armazenam dados. Essa habilidade é um dos primeiros passos para dominar temas como lógica digital, manipulação de bits e desenvolvimento de sistemas.

###### Estudo de Caso:

Cenário: Em uma escola técnica, a professora de lógica de programação propôs um desafio para seus alunos do primeiro ano: desenvolver um miniaplicativo em JavaScript que converta números decimais em binários.

Pedro, um dos alunos mais curiosos, não compreendia por que isso era tão importante. Para ele, "isso parece coisa de matemática pura". Durante a aula, a professora explicou que a conversão é usada, por exemplo, para definir endereços de memória, valores de controle de portas lógicas, configurações de registradores, cores em telas, e muito mais.

Agora, Pedro e sua equipe devem:

- Entender como funciona a conversão decimal → binário.
- Implementar um algoritmo que faça essa transformação.
- Testar diferentes entradas para garantir que o sistema funcione corretamente.
Esse projeto vai ajudá-los a compreender como a linguagem humana (decimal) é transformada em linguagem de máquina (binário), e por que essa habilidade é essencial no desenvolvimento de sistemas computacionais.

Questões:

- Liste os passos necessários para converter um número decimal para binário manualmente.
- Explique, com suas próprias palavras, por que os computadores utilizam o sistema binário ao invés do sistema decimal.
- Converta manualmente o número decimal 45 para binário. Mostre todos os passos da conversão.
- Quais são os principais componentes de um algoritmo que converte números decimais em binários? Como esses componentes se conectam no processo de execução do código?
- Pedro acha que aprender binário não tem aplicação prática. Você concorda com ele? Justifique sua resposta, relacionando com o desenvolvimento de sistemas.
- Desenvolva um esboço de um programa que receba um número decimal como entrada do usuário e exiba sua conversão binária. A interface deve ser simples e permitir múltiplas conversões.
