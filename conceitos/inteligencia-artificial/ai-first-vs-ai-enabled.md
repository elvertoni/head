---
conceito: AI-First vs AI-Enabled
slug: ai-first-vs-ai-enabled
...
Enabled cola uma ferramenta no processo antigo; first redesenha o processo em torno da IA.
...
- "Instalei uma ferramenta de IA, logo sou AI-first" — só habilitar é AI-enabled.
...
- Canônica da Aula 22 (modo Material); transcrição ia-coders (lake).
