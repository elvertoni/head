...
tipo: conceito
aka: [media queries, consulta de mídia CSS]
status: rascunho
fontes:
...
Media queries condicionam estilos às características do ambiente de visualização.
...
- Criar breakpoints para marcas específicas em vez de necessidades do layout.
- Esconder conteúdo importante em telas menores.
- Testar somente uma largura e ignorar zoom, orientação e toque.
...
- Resumo da Aula 9, páginas 1 e 4–7: media queries e adaptação de estilos.
