# Brief de imagem — Aula 11: Cor e tipografia: a marca em seis linhas de CSS
...
- **prompt:** (esboço) mesma página em duas versões, uma com a cor de destaque espalhada e outra com a cor só no botão, indicando para onde o olho vai em cada uma.
