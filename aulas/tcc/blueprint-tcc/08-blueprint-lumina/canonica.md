---
titulo: Blueprint · Lumina
tema: Blueprints de TCC
disciplina: tcc
serie: 3a-serie
prerequisitos: []
objetivos:
  - Compreender a arquitetura e os requisitos do projeto Lumina
...
Ao final desta leitura, você será capaz de compreender a arquitetura e os requisitos do projeto Lumina.
...
Checklist de revisão da equipe (todos confirmados):
- Problema descrito com situação real e específica
- Público-alvo com perfis e necessidades identificadas
- Solução conectada diretamente ao problema
- Requisitos funcionais escritos como verbos de ação (RF01...RF09)
- Requisitos não funcionais descrevem comportamento e qualidade
- Tecnologias com justificativa técnica contextualizada
- Fluxo completo em etapas numeradas cobrindo login → uso → saída
- Escopo viável para desenvolvimento individual/dupla em semestre letivo

[A FAZER] Escrever a autoavaliação em prosa: viabilidade no prazo, MVP x extras, riscos e mitigação.
